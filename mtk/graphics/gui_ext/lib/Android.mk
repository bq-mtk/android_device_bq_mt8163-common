...
LOCAL_C_INCLUDES:= \
    ...
    $(TOP)/device/bq/mt8163-common/mtk/graphics/gui_ext/inc \
    $(TOP)/device/bq/mt8163-common/mtk/graphics/ui_ext/inc \
    $(TOP)/device/bq/mt8163-common/mtk/graphics/gralloc_extra/include

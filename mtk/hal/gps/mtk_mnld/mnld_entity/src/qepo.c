...
static void quarter_epo_bd_download_process(void) {
    strncpy(quarter_epo_bd_file_name, "QBD.DAT",sizeof(quarter_epo_bd_file_name));
    strncpy(quarter_epo_bd_md_file_name, "QBD.MD5",sizeof(quarter_epo_bd_md_file_name));
